...
current_file = "./db/data/photos.csv"
current_table_name = "photos"
...
for idx, chunk in enumerate(pd.read_csv(current_file, encoding='us-ascii', chunksize=chunksize, dtype=column_data_types, usecols=columns_to_use)):
